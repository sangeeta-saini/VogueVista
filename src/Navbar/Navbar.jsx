        ...
        <div className='list'>
          <ul className='list-items'>
           <li><a href='/MenSection'>MEN</a></li>
            ...
            <li><a href='/BeautySection'>BEAUTY</a></li>
          </ul>
        </div>
        <SearchBar />
        <div className='container-2'>
          <div>
           <div className='sign-up'><a href='Signup'>Login</a></div>
          </div>
        <div className='user'>
       <a href='Profile'> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.03741 7.31C8.03741 5.169 9.77941 3.428 11.9204 3.428C14.0604 3.428 15.8014 5.169 15.8014 7.31C15.8014 9.45 14.0604 11.192 11.9204 11.192V11.906L11.8914 11.192C9.75941 11.184 8.03041 9.444 8.03741 7.31ZM11.8884 12.619H11.9204C14.8484 12.619 17.2294 10.238 17.2294 7.31C17.2294 4.382 14.8484 2 11.9204 2C8.99141 2 6.60941 4.382 6.60941 7.307C6.59941 10.227 8.96641 12.61 11.8884 12.619ZM5.5 18.1731C5.5 16.7281 7.66 15.9961 11.921 15.9961C16.181 15.9961 18.34 16.7351 18.34 18.1931C18.34 19.6381 16.181 20.3701 11.921 20.3701C7.66 20.3701 5.5 19.6311 5.5 18.1731ZM4 18.1731C4 21.8701 9.962 21.8701 11.921 21.8701C15.32 21.8701 19.84 21.4891 19.84 18.1931C19.84 14.4961 13.88 14.4961 11.921 14.4961C8.521 14.4961 4 14.8771 4 18.1731Z" fill="#211A1E"/>
</svg></a>
        </div>
